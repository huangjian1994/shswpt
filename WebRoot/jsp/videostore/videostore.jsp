...
function goVideoOpen(zjID){
	...
	//document.myForm.submit();
	window.open(dizhi, "displayWindow", "menubar=yes,left=300,top=100,width=800,height=600");
}
</script>
	<body class="gray-bg">
    ...
    <div id="sideBarContents" style="display:none;">
		...
		<div id="dLeft">
			<ul class="nav">
				<li>
					<a style="padding: 0;" href="#" onclick="docheck()" title="本地上传"><i class="iconfont icon-msnui-cloud-upload"></i></a>
				</li>
				<li>
                    <a style="padding: 0;" href="<%=basePath%>/videostore/videostore_fetchVideo.do" title="本地视频"><i class="iconfont icon-bofang"></i></a>
                </li>
                <li>
                    <a style="padding: 0;" href="<%=basePath %>/selectvideo_selectVideoStore.do" title="手机视频"><i class="iconfont icon-shouji"></i></a>
                </li>
			</ul>
		</div>
					 ...
					 <table>
					 	<tr>
							...
							<ul style="text-align:left;" align="left">
								...
								<li>
									<a href="#" onclick="goCxbq('突发事件')">突发事件</a>
								</li>
								<li>
									<a href="#">更多</a>
								</li>
