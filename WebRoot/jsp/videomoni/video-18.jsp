...
function init(){
	...
	nRet = obj.DPSDK_StartRealplayByWndNo(gWndId, 0, "1000009$1$0$0", 1, 1, 1);//第一个子窗口打开视频,视频通道号1000605$1$0$0，此字段的获取请参考开发包中附带的《组织树XML解析手册》和《常见问题解答文档》
...
<input type="hidden" id="textCameraID" value="1000009$1$0$0" />
